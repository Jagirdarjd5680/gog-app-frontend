...
/** Second step of login for accounts with 2FA enabled — reached from Login.jsx when login() returns requiresTwoFactor. */
            ...
            <Card sx={{ maxWidth: 440, width: '100%', boxShadow: '0 10px 40px rgba(0,0,0,0.12)' }}>
                <CardContent sx={{ p: { xs: 3, sm: 5 } }}>
                    <Box sx={{ textAlign: 'center', mb: 3 }}>
                        ...
                        <Typography variant="body2" fontWeight={700} sx={{ color: primaryColor, mb: 0.5 }}>
                            {maskEmail(email)}
                        </Typography>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Box sx={{ display: 'flex', gap: 1.2, justifyContent: 'center', mb: 4 }} onPaste={handlePaste}>
                            {otp.map((digit, index) => (
                                <Box
                                    key={index}
                                    component="input"
                        ...
                        <Box sx={{ textAlign: 'center', mt: 3 }}>
                            ...
                            {resendTimer > 0 ? (
                                ...
                                <Button
                                    ...
                                    startIcon={resendLoading ? <CircularProgress size={13} /> : null}
                                >
                        ...
                        <Box sx={{ textAlign: 'center', mt: 1.5 }}>
                            <Button variant="text" size="small" onClick={() => navigate('/login')} sx={{ color: 'text.secondary', fontSize: '0.78rem' }}>
                                ← Back to Sign In
                            </Button>
                        </Box>
                    </form>
