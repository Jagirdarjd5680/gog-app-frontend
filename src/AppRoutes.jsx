...
const AllCourses = lazy(() => import('./pages/StudentCourses/AllCourses'));
const CourseDetail = lazy(() => import('./pages/StudentCourses/CourseDetail'));
const CourseViewerLayout = lazy(() => import('./pages/CourseViewer/CourseViewerLayout'));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/verify-2fa" element={isAuthenticated ? <Navigate to="/" replace /> : <VerifyTwoFactor />} />
        ...
        {/* Full-viewport course player — deliberately outside MainLayout, no admin sidebar/topbar */}
        <Route path="/my-courses/:id" element={<ProtectedRoute allowedRoles={['student']}><CourseViewerLayout /></ProtectedRoute>} />

        {/* Protected Routes */}
        <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
          <Route index element={user?.role === 'tutor' ? <Navigate to="/tutor/dashboard" replace /> : <Dashboard />} />
          <Route path="users" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'students', action: 'view' }}><UserList /></ProtectedRoute>} />
          ...
          <Route path="courses" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'courses', action: 'view' }}><CourseList /></ProtectedRoute>} />
          ...
          <Route path="exam-management" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'exams', action: 'view' }}><ExamList /></ProtectedRoute>} />
          <Route path="exam-results/*" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'exams', action: 'view' }}><Routes><Route index element={<ExamResults />} /><Route path=":examId" element={<ExamResults />} /><Route path="details/:resultId" element={<IndividualResult />} /></Routes></ProtectedRoute>} />
          <Route path="question-bank" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'exams', action: 'view' }}><QuestionBank /></ProtectedRoute>} />
          ...
          <Route path="chat" element={<ProtectedRoute allowedRoles={['admin', 'teacher', 'student']} requiredPermission={{ module: 'chat', action: 'view' }}><ChatCenter /></ProtectedRoute>} />
          ...
          <Route path="booking" element={<ProtectedRoute allowedRoles={['admin']}><BookingLayout /></ProtectedRoute>} />
          <Route path="timetable" element={<ProtectedRoute allowedRoles={['admin', 'teacher']}><TimetableAdmin /></ProtectedRoute>} />
          <Route path="referrals" element={<ProtectedRoute allowedRoles={['student']}><RequireEnrollment><ReferralDashboard /></RequireEnrollment></ProtectedRoute>} />
          <Route path="my-rewards" element={<ProtectedRoute allowedRoles={['student']}><RequireEnrollment><MyRewards /></RequireEnrollment></ProtectedRoute>} />
          <Route path="my-payments" element={<ProtectedRoute allowedRoles={['student']}><RequireEnrollment><MyPayments /></RequireEnrollment></ProtectedRoute>} />
          ...
          <Route path="account-settings" element={<ProtectedRoute allowedRoles={['student']}><AccountSettings /></ProtectedRoute>} />
          <Route path="all-courses" element={<ProtectedRoute allowedRoles={['student']}><AllCourses /></ProtectedRoute>} />
          <Route path="all-courses/:id" element={<ProtectedRoute allowedRoles={['student']}><CourseDetail /></ProtectedRoute>} />
        ...
        <Route path="question-bank/bulk-edit/:editId" element={<ProtectedRoute allowedRoles={['admin', 'teacher']} requiredPermission={{ module: 'exams', action: 'edit' }}><BulkQuestionEdit /></ProtectedRoute>} />
